...
In order to encourage Claude to respond with solutions in the correct
style, it is helpful to provide a few examples and insert them in the
conversation history

------------------------------------------------------------------------

<a
href="https://github.com/agemoai/arcsolver/blob/main/arcsolver/examples.py#L14"
target="_blank" style="float:right; font-size:smaller">source</a>

### Example

>  Example (description:str, reasoning:str, new_primitives:str,
>               input_model:str, output_model:str)
...
![](05_examples_files/figure-commonmark/cell-3-output-1.png)
...
![](05_examples_files/figure-commonmark/cell-5-output-1.png)
...
![](05_examples_files/figure-commonmark/cell-7-output-1.png)
